...
namespace Computer_Store.Controllers
{
    public class PenjualanBarangController : Controller
    {
        ...
        {
            var penjualanBarangs = db.PenjualanBarangs.Include(p => p.Customer).Include(p => p.Pembayaran).Include(p => p.Produk).Include(p => p.Staff);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.IDPembayaran = new SelectList(db.Pembayarans, "IDPembayaran", "JenisPembayaran");
        ...
        public ActionResult Create([Bind(Include = "IDPenjualan,IDproduk,JumlahBarang,HargaProduk,TanggalPembelian,IDCustomer,IDStaff,IDPembayaran")] PenjualanBarang penjualanBarang)
        {
            ...
            ViewBag.IDPembayaran = new SelectList(db.Pembayarans, "IDPembayaran", "JenisPembayaran", penjualanBarang.IDPembayaran);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDPenjualan,IDproduk,JumlahBarang,HargaProduk,TanggalPembelian,IDCustomer,IDStaff,IDPembayaran")] PenjualanBarang penjualanBarang)
        {
            if (ModelState.IsValid)
            {
