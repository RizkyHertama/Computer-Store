...
namespace Computer_Store.Controllers
{
    public class PembelianBarangController : Controller
    {
        ...
        {
            var pembelianBarangs = db.PembelianBarangs.Include(p => p.Pembayaran).Include(p => p.Produk).Include(p => p.Staff).Include(p => p.Supplier);
        ...
        public ActionResult Create([Bind(Include = "IDPembelian,IDproduk,JumlahBarang,HargaProduk,TanggalPembelian,IDSupplier,IDStaff,IDPembayaran")] PembelianBarang pembelianBarang)
        {
            ...
            ViewBag.IDPembayaran = new SelectList(db.Pembayarans, "IDPembayaran", "JenisPembayaran", pembelianBarang.IDPembayaran);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDPembelian,IDproduk,JumlahBarang,HargaProduk,TanggalPembelian,IDSupplier,IDStaff,IDPembayaran")] PembelianBarang pembelianBarang)
        {
            if (ModelState.IsValid)
            {
